#!/usr/bin/env python3
"""
Run the CloudLab channel single-sender multi-receiver workflow.

The experiment TOMLs decide the topology through [[participants]]. Formal
9-node experiments use node-0 as sender/orchestrator and node-1..node-8 as
receivers, while smoke TOMLs may name fewer receivers. The Rust runner sweeps
sender push rate and reports receiver-delivered throughput.
"""
...
EXPERIMENTS_32B = [
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-fanout-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-fanout-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-competitive-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-competitive-32b.toml",
]
EXPERIMENTS_16M = [
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-fanout-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-fanout-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-competitive-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-competitive-16m.toml",
]
EXPERIMENTS_128M = [
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-fanout-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-fanout-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-competitive-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-competitive-128m.toml",
]
EXPERIMENTS_1G = [
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-fanout-1g.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-fanout-1g.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/s3-competitive-1g.toml",
    "config/experiments/channel/single-sender-multi-receiver/9node/p2p-competitive-1g.toml",
]
EXPERIMENTS_SMOKE_3NODE_32B = [
    "config/experiments/channel/single-sender-multi-receiver/smoke/3node-s3-fanout-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/smoke/3node-p2p-fanout-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/smoke/3node-s3-competitive-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/smoke/3node-p2p-competitive-32b.toml",
]
EXPERIMENTS_TEMP_3NODE_ALL = [
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-fanout-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-fanout-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-competitive-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-competitive-32b.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-fanout-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-fanout-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-competitive-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-competitive-16m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-fanout-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-fanout-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-competitive-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-competitive-128m.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-fanout-1g.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-fanout-1g.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/s3-competitive-1g.toml",
    "config/experiments/channel/single-sender-multi-receiver/3node/p2p-competitive-1g.toml",
]
EXPERIMENT_SETS = {
    "9node-32b": EXPERIMENTS_32B,
    "9node-16m": EXPERIMENTS_16M,
    "9node-128m": EXPERIMENTS_128M,
    "9node-1g": EXPERIMENTS_1G,
    "32b": EXPERIMENTS_32B,
    "16m": EXPERIMENTS_16M,
...
S3_BUCKET_PREFIXES = ["lcbench-channel"]
DYNAMODB_TABLE_PREFIXES = [
    "lcbench_channel_metadata",
    "lcbench_channel_p2p_meta",
    "lcbench_channel_p2p_holders",
]
...
def require_allocate_profile(args: argparse.Namespace) -> None:
    ...
    if actual != args.expected_profile:
        raise RuntimeError(
            f"channel channel workflow expects CloudLab profile {args.expected_profile!r}; "
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--csv-output", default=os.environ.get("CHANNEL_SINGLE_SENDER_MULTI_RECEIVER_CSV_OUTPUT"))
    parser.add_argument(
        "--aws-gc-workers",
        type=int,
    ...
    parser.add_argument(
        "--expected-profile",
        default=os.environ.get("CHANNEL_SINGLE_SENDER_MULTI_RECEIVER_EXPECTED_PROFILE", EXPECTED_PROFILE),
    ...
    parser.add_argument(
        "--experiments",
        nargs="+",
        help="explicit channel single-sender multi-receiver experiment TOMLs; overrides --experiment-set",
    )
    parser.add_argument(
        "--experiment-set",
        choices=sorted(EXPERIMENT_SETS),
        default=os.environ.get("CHANNEL_SINGLE_SENDER_MULTI_RECEIVER_EXPERIMENT_SET", "all"),
    )
...
def configure_workflow_outputs(args: argparse.Namespace) -> None:
    outputs = workflow_paths.workflow_outputs(
        ...
        workflow_name="channel-single-sender-multi-receiver",
        csv_prefix="channel-single-sender-multi-receiver",
